...
### 1.1 Concept central
On interagit avec un assistant IA nommé **Écho**. Au fil du jeu, on délègue progressivement ses tâches cognitives à Écho. Les capacités propres déclinent. On peut choisir de résister, de récupérer, ou de laisser faire jusqu'au silence complet.

Le jeu est une exploration de l'**agentivité humaine face à l'automatisation cognitive**. Il n'y a pas de bonne réponse. Trois fins sont possibles selon ce qu'on choisit de garder ou de laisser.
### 1.2 Monde
**Uchronie "douce" à quelques mois.** Pas de robots, pas de catastrophe. Un monde où les outils IA actuels ont été adoptés un peu plus vite, un peu plus profondément. Suffisamment familier pour que on se reconnaisse, suffisamment décalé pour autoriser la fiction.
### 1.3 Nom
...
- Ce n'est pas un jeu qui punit on pour ses choix.
...
Contrairement aux jeux incrementaux classiques où les ressources augmentent, dans Écho **les ressources humaines baissent** quand on délègue.

```
Jeu incremental classique : déléguer → tout augmente
Écho : déléguer → temps libéré augmente, capacités humaines baissent
```
...
|---|---|---|---|
| Agentivité | Capacité à décider par soi-même | On écrit lui-même | Chaque délégation + fonctions passives actives |
| Créativité | Capacité à produire de l'original | On écrit lui-même | Écho génère à sa place |
| Curiosité | Capacité à formuler des questions | On lit soi-même | Écho cherche, résume, filtre |
...
|---|---|---|
| Temps libéré | Minutes gagnées grâce à Écho | Augmente toujours. "Pour faire quoi ?" est la vraie question. |
...
| Page du carnet | Implication personnelle | Part de 47, monte quand on écrit soi-même. Référencé dans les fins de jeu. |

### 3.3 Plafond des ressources humaines
Les ressources humaines sont plafonnées à 100. Il n'y a pas de "sur-agentivité", de "sur-créativité", etc. Le plafond est une affirmation : on ne peut pas devenir meilleur que soi-même de départ. On peut seulement rester soi-même ou l'être moins.

### 3.4 Mécanique de délégation — Écho propose
Écho propose des **tâches concrètes** dans la console narrative : rédiger une réponse, résumer un document, préparer des notes. On peut accepter ("⟳ Écho agit") ou agir lui-même. Les propositions évoluent selon l'acte. Si on appuie sur "Écho agit" sans tâche en cours, Écho en propose de nouvelles.

### 3.5 Mécanique du joueur — Tu proposes
Trois actions permanentes sont disponibles dans la barre du bas dans la barre du bas :
...
Dès qu'au moins un projet Écho est activé, les jauges humaines déclinent en temps réel (boucle à 100ms). L'inaction est un choix par défaut, celui du déclin des compétences.
...
La transition entre actes n'est pas annoncée à l'avance; elle se ressent.

---

## 3. Les projets Écho (15)

Chaque projet est une **fonction permanente** que on active. Effet immédiat sur les jauges + taux de dégradation passif installé définitivement. Débloqués progressivement selon conditions.
...
Les deux voix ne se répondent quasiment jamais directement, Écho souligne seulement le geste d'écriture. Elles coexistent comme deux angles sur la même scène.
...
Quand on tape un texte, Écho répond 65% du temps avec un décalage de 900–1400ms. Il ne commente pas le contenu — il commente le fait que on ait écrit lui-même. Les répliques évoluent par acte :
...
Curseur `_` clignotant en bleu à la fin de chaque message. Disparaît dès que on agit.
...
On ne reçoit pas un cours sur l'agentivité. **Il la perd en jouant.**

### 8.2 Les notes pédagogiques
- Apparaissent à l'activation de chaque projet Écho.
- Optionnelles — on peut les fermer.
...
### Fin B — LA RECONQUÊTE
*Écho a été désactivé et récupéré ses jauges.*
...
### Fin C — L'OUTIL
*Toutes les jauges maintenues au-dessus de 50%.*
...
**Principe de la palette** : tout est chaud côté humain, Écho est froid (machine). L'intrusion est lisible au premier coup d'œil.
...
Deux fichiers : `index.html` (page d'ouverture) et `echo.html` (jeu). Le jeu est un fichier HTML unique, autonome. Pas de dépendances externes sauf Google Fonts.
...
- **`G.page`** : compteur de pages du carnet, avance quand on écrit avec du contenu.
