...
| Page du carnet | Implication personnelle | Part de 47, monte quand le joueur écrit lui-même. Référencé dans les fins de jeu. |
...
Écho propose des **tâches concrètes** dans la console narrative : rédiger une réponse, résumer un document, préparer des notes. Le joueur peut accepter ("⟳ Écho agit") ou agir lui-même. Les propositions évoluent selon l'acte. Si le joueur appuie sur "Écho agit" sans tâche en cours, Écho en propose de nouvelles.

### 3.5 Mécanique du joueur — Tu proposes
Le joueur dispose de trois actions permanentes dans la barre du bas :
...
Le joueur ne reçoit pas un cours sur l'agentivité. **Il la perd en jouant.**
